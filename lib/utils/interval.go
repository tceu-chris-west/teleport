...
type IntervalConfig struct {
	...
	// It is usually preferable to use NewSmallJitter for this parameter, since
	// periodic operations are typically costly and the affect of the jitter is
	// cumulative.
	Jitter Jitter
}

// NewInterval creates a new interval instance.  This function panics on non-positive
